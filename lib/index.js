...
var bundle_audit_to_json = function bundle_audit_to_json() {
  var base_dir = _.has(process, "pkg.defaultEntrypoint") ? path.join(path.dirname(process.execPath), "node_modules", "vile-bundler-audit") : path.join(__dirname, "..");
